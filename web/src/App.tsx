      ...
      <div className="login-container">
        <div className="login-card">
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: 12, marginTop: 8, width: '100%', maxWidth: 300 }}>
            {API_BASE ? (
              <>
                <a className="btn btn-primary" href={getAuthUrl()} style={{ padding: '12px 32px', fontSize: 15, textAlign: 'center', display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 8 }}>
                ...
                {authProviders.google ? (
                  <a className="btn btn-secondary" href={getGoogleAuthUrl()} style={{ padding: '12px 32px', fontSize: 15, textAlign: 'center', display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 8, background: '#fff', color: '#333', border: '1px solid #ddd' }}>
                  ...
                  <button className="btn btn-secondary" disabled style={{ padding: '12px 32px', fontSize: 15, opacity: 0.5, display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 8 }}>
                ...
                <p style={{ fontSize: 11, color: '#888', marginTop: 4, textAlign: 'center' }}>
                  ...
                  Discord login required for full guild access.
                </p>
              </>
            ) : (
