            ...
            {API_BASE ? (
              <>
                {authProviders.google ? (
                  <a className="btn btn-primary" href={getGoogleAuthUrl()} onClick={() => localStorage.removeItem('dcb_token')} style={{ padding: '12px 32px', fontSize: 15, textAlign: 'center', display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 8 }}>
                  ...
                  <button className="btn btn-primary" disabled style={{ padding: '12px 32px', fontSize: 15, opacity: 0.5, display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 8 }}>
                ...
                <a className="btn btn-secondary" href={getAuthUrl()} onClick={() => localStorage.removeItem('dcb_token')} style={{ padding: '12px 32px', fontSize: 15, textAlign: 'center', display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 8 }}>
