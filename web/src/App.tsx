...
import api, { API_BASE, IS_CAPACITOR, getAuthUrl, getGoogleAuthUrl, getGoogleLinkUrl, getDiscordLinkUrl } from './api'
import { startMobileLogin } from './mobileAuth'
      ...
      <div className="login-container">
        <div className="login-card">
          <div style={{ marginBottom: 20 }}>
            <img src="/logo-192.png" alt="DCB" style={{ width: 72, height: 72, margin: '0 auto 14px', objectFit: 'contain', filter: 'drop-shadow(0 8px 24px rgba(99,140,255,0.3))' }} />
          </div>
            ...
            {API_BASE ? (
              <>
                {authProviders.google ? (
                  <a className="btn btn-primary" href={getGoogleAuthUrl()} onClick={(e) => {
                    localStorage.removeItem('dcb_token')
                    if (IS_CAPACITOR) { e.preventDefault(); startMobileLogin(getGoogleAuthUrl()) }
                  }} style={{ padding: '13px 32px', fontSize: 15, textAlign: 'center', display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 10 }}>
                ...
                <a className="btn btn-secondary" href={getAuthUrl()} onClick={(e) => {
                  localStorage.removeItem('dcb_token')
                  if (IS_CAPACITOR) { e.preventDefault(); startMobileLogin(getAuthUrl()) }
                }} style={{ padding: '13px 32px', fontSize: 15, textAlign: 'center', display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 10 }}>
      ...
      <div className="mobile-app">
        ...
        <header className="mobile-header">
          <div className="mobile-header-left">
            <img src="/logo-192.png" alt="DCB" className="mobile-header-logo" style={{ width: 32, height: 32, objectFit: 'contain', flexShrink: 0 }} />
    ...
    <div className="app-layout">
      ...
      <aside className={`sidebar ${sidebarOpen ? 'open' : ''}`}>
        <div className="sidebar-brand">
          <img src="/logo-192.png" alt="DCB" className="sidebar-brand-logo" style={{ width: 36, height: 36, objectFit: 'contain', flexShrink: 0 }} />
